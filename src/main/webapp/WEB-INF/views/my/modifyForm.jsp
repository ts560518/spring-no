...
<div class="container">
	<div class="row" style="margin-top: 50px;">
		<div class="col-8 offset-2" >
			<h2 class="text-center" style="font-weight: bold; margin-bottom: 30px;">회원정보수정</h2>
			<div>
				<form id="user-form" method="post" action="updateUser.do" enctype="multipart/form-data">
					<table class="table table-bordered">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<div class="d-flex justify-content-start mb-1">
										...
										<button id="user-id-check" type="button" style="font-size: 80%; height: 31px;" class="btn btn-success btn-sm form-control ml-1 w-25" disabled>중복체크</button>
									</div>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input type="date" class="form-control form-control-sm" name="birth" id="user-birth" value='<fmt:formatDate value="${user.birth }" pattern="yyyy-MM-dd" />' disabled /> </td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td>
									<div class="d-flex justify-content-start">
										<input type="text" class="form-control form-control-sm" name="email" id="user-email" value="${user.email }" disabled/>
										<input type="button" class="btn btn-success btn-sm ml-1" style="font-size: 80%; height: 31px;" id="btn-send-random" value="이메일 인증" disabled/>
									</div>
								...
								<td class="align-middle">
									<div class="form-check-inline">
										<label class="form-check-label">
											<input type="radio" class="form-check-input" name="emailReceivingConsent" id="consent-email" value="Y" ${user.emailReceivingConsent eq 'Y' ? 'checked' : '' }> 동의
										</label>
									</div>
									<div class="form-check-inline">
										<label class="form-check-label">
											<input type="radio" class="form-check-input" name="emailReceivingConsent" id="refusal-email" value="N" ${user.emailReceivingConsent eq 'N' ? 'checked' : '' }> 거부
										</label>
									</div>
								</td>
							</tr>
							<tr>
								...
								<td class="align-middle">
									<div class="form-check-inline">
										<label class="form-check-label">
											<input type="radio" class="form-check-input" name="smsReceivingConsent" id="consent-SMS" value="Y" ${user.smsReceivingConsent eq 'Y' ? 'checked' : '' }> 동의
										</label>
									</div>
									<div class="form-check-inline">
										<label class="form-check-label">
											<input type="radio" class="form-check-input" name="smsReceivingConsent" id="refusal-SMS" value="N" ${user.smsReceivingConsent eq 'N' ? 'checked' : '' }> 거부
										</label>
									</div>
								</td>
							</tr>
